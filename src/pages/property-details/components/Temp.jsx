    ...
    <div ref={containerRef} className="card p-6">
      ...
      {selectedListing ? (
        <div>
          ...
          {/* Property Details - Following your theme pattern */}
          <div className="card p-6">
            <div className="space-y-6">
              ...
              {/* Two Column Layout - Better aligned */}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="card p-4">
                        ...
                        <div className="text-text-primary font-semibold capitalize mt-1">{selectedListing.type}</div>
                      </div>
                      
                      <div className="card p-4">
                        <div className="text-text-secondary text-sm">Bedrooms</div>
                        <div className="text-text-primary font-semibold mt-1">{selectedListing.bedrooms || '-'}</div>
                      </div>
                      
                      <div className="card p-4">
                        <div className="text-text-secondary text-sm">Bathrooms</div>
                        <div className="text-text-primary font-semibold mt-1">{selectedListing.bathrooms || '-'}</div>
                      </div>
                      
                      <div className="card p-4">
                        <div className="text-text-secondary text-sm">Date Added</div>
                        <div className="text-text-primary font-semibold mt-1">{formatDate(selectedListing.createdAt)}</div>
                      </div>
                    </div>

                    {/* Available From Date - Only show for occupied properties */}
                    {selectedListing.status?.toLowerCase() === 'occupied' && selectedListing.availableFrom && (
                      <div className="card p-4 bg-yellow-50 border border-yellow-200 mt-4">
                        <div className="text-yellow-800 text-sm font-medium flex items-center">
                          <CalendarIcon />
                          <span className="ml-2">Available From</span>
                        </div>
                        <div className="text-yellow-900 font-semibold mt-1">{formatDate(selectedListing.availableFrom)}</div>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <button 
                        ...
                        className="w-full card p-4 text-left hover:bg-gray-50 transition-colors flex items-center"
                      >
                      ...
                      <button 
                        ...
                        className="w-full btn-primary p-4 rounded-md flex items-center justify-center"
                      >
                      ...
                      <button 
                        ...
                        className="w-full card p-4 text-red-700 hover:bg-red-50 border border-red-200 transition-colors flex items-center justify-center"
                      >
                        <svg className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
